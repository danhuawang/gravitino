...
/** Service class for SCIM v2 group metadata database operations. */
public class ScimGroupMetaService {
  ...
  /** Returns the singleton SCIM v2 group metadata service instance. */
  ...
  public boolean softDeleteScimGroup(String externalId) {
    Integer deleted =
        SessionUtils.doWithCommitAndFetchResult(
            ScimGroupMetaMapper.class, mapper -> mapper.softDeleteByExternalId(externalId));
