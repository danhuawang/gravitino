...
import com.datastrato.gravitino.scim.v2.dto.ScimTokenSummaryDTO;
...
import com.datastrato.gravitino.scim.v2.web.ScimManagement;
import com.datastrato.gravitino.scim.v2.web.ScimOperationType;
import com.datastrato.gravitino.scim.v2.web.ScimRESTUtils;
...
/** REST resource for SCIM v2 token administration on the main Gravitino server. */
@ScimManagement
@Path("/scim/tokens")
