...
/** Service class for SCIM v2 user metadata database operations. */
public class ScimUserMetaService {
  ...
  /** Returns the singleton SCIM v2 user metadata service instance. */
  ...
  public boolean updateScimUserEnabled(String externalId, boolean enabled) {
    Integer updated =
        SessionUtils.doWithCommitAndFetchResult(
            ScimUserMetaMapper.class, mapper -> mapper.updateEnabled(externalId, enabled));
  ...
  public boolean softDeleteScimUser(String externalId) {
    Integer deleted =
        SessionUtils.doWithCommitAndFetchResult(
            ScimUserMetaMapper.class, mapper -> mapper.softDeleteByExternalId(externalId));
