...
import com.datastrato.gravitino.scim.v2.basic.token.ScimTokenGenerator;
import com.datastrato.gravitino.scim.v2.basic.token.ScimTokenGenerator.GeneratedToken;
import com.datastrato.gravitino.scim.v2.model.CreatedScimToken;
import com.datastrato.gravitino.scim.v2.model.ScimProvisioningSummary;
...
import com.datastrato.gravitino.scim.v2.storage.relational.ScimGarbageCollector;
...
/** Manager for SCIM v2 token lifecycle and bearer authentication. */
public class ScimTokenManager implements Closeable {
  ...
  /** Returns the shared SCIM v2 token manager for the server process. */
  ...
  /** Builds the SCIM v2 provisioning overview row. */
