...
import com.datastrato.gravitino.scim.v2.storage.mapper.provider.h2.ScimGroupMetaH2Provider;
import com.datastrato.gravitino.scim.v2.storage.mapper.provider.postgresql.ScimGroupMetaPostgreSQLProvider;
import com.google.common.collect.ImmutableMap;
import java.util.Map;
import org.apache.gravitino.storage.relational.JDBCBackend.JDBCBackendType;
import org.apache.ibatis.annotations.Param;

/** Factory that selects the SCIM v2 group metadata SQL provider for the active JDBC backend. */
public class ScimGroupMetaSQLProviderFactory {
  ...
  public static String insert(
      @Param("groupMeta") com.datastrato.gravitino.scim.v2.storage.po.ScimGroupMetaPO groupMeta) {
