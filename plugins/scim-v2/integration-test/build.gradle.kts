...
dependencies {
  ...
  testImplementation(project(":plugins:scim-v2", "testArtifacts"))
  testImplementation(project(":plugins:scim-v2:service"))
...
tasks.test {
  ...
  if (skipITs) {
    ...
    dependsOn(":plugins:scim-v2:service:copyLibAndConfigs")
    dependsOn(":plugins:scim-v2:copyLibAndConfigs")
  }
