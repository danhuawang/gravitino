...
import com.datastrato.gravitino.scim.v2.service.adapter.ScimGroupRepositoryAdapter;
import com.datastrato.gravitino.scim.v2.service.adapter.ScimUserRepositoryAdapter;
...
/** Jersey 3 application wiring SCIMple resources under {@link ScimV2Resource}. */
public final class GravitinoScimApplication {
  ...
  public static ResourceConfig create(Config gravitinoConfig, ScimConfig scimConfig) {
    ...
    resourceConfig.register(ScimV2Resource.class);
