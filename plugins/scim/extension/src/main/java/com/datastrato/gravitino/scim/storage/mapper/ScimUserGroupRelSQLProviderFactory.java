...
/** Factory for SCIM user-group membership SQL providers. */
public class ScimUserGroupRelSQLProviderFactory {
  ...
  /**
   * Delegates batch membership lookup SQL to the active backend provider.
   *
   * @param groupIds group ids
   * @return SELECT SQL script
   */
  public static String selectMembersByGroupIds(@Param("groupIds") List<Long> groupIds) {
    return currentProvider().selectMembersByGroupIds(groupIds);
  }
