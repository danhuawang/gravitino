...
/** Garbage collector for SCIM token, membership, and error-history metadata expiry and purge. */
public final class ScimGarbageCollector implements Closeable {
  ...
  /**
   * Creates a garbage collector for SCIM token, membership, and error-history metadata.
   *
