...
/**
 * User resource that fixes SCIMple {@code 1.0.0-M1} {@code Location} for single-resource calls.
 *
 ...
 */
public final class GravitinoUserResourceImpl extends UserResourceImpl {

  @Context private UriInfo uriInfo;

  /**
   * Creates a User resource backed by the given registries.
   *
   * @param schemaRegistry SCIMple schema registry
   * @param repositoryRegistry SCIMple repository registry
   */
  public GravitinoUserResourceImpl(
