...
/** Event triggered before a SCIM add Group operation. */
@DeveloperApi
public class ScimAddGroupPreEvent extends ScimGroupPreEvent {

  private final String groupName;

  /**
   * Creates a SCIM add Group pre-event.
   *
