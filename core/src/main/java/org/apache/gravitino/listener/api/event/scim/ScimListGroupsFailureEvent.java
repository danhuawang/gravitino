...
/** Event triggered when a SCIM list/find Groups operation fails. */
@DeveloperApi
public class ScimListGroupsFailureEvent extends ScimGroupFailureEvent {

  private final int startIndex;
  private final int count;

  /**
   * Creates a SCIM list Groups failure event.
   *
   ...
   */
  public ScimListGroupsFailureEvent(
