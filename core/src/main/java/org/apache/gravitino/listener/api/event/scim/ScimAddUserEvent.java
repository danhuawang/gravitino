...
/** Event triggered after a successful SCIM add User operation. */
@DeveloperApi
public class ScimAddUserEvent extends ScimUserEvent {

  private final String userName;

  /**
   * Creates a SCIM add User success event.
   *
