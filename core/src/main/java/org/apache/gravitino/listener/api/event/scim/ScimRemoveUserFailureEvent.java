...
/** Event triggered when a SCIM remove User operation fails. */
@DeveloperApi
public class ScimRemoveUserFailureEvent extends ScimUserFailureEvent {

  private final String userName;

  /**
   * Creates a SCIM remove User failure event.
   *
   ...
   */
  public ScimRemoveUserFailureEvent(
      String initiator,
      String metalake,
      Exception exception,
      String userName,
