...
/** Event triggered when a SCIM alter User operation fails. */
@DeveloperApi
public class ScimAlterUserFailureEvent extends ScimUserFailureEvent {

  private final String userName;

  /**
   * Creates a SCIM alter User failure event.
   *
   ...
   */
  public ScimAlterUserFailureEvent(
      String initiator,
      String metalake,
      Exception exception,
      String userName,
