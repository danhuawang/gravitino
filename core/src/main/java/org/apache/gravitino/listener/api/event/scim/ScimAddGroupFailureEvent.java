...
/** Event triggered when a SCIM add Group operation fails. */
@DeveloperApi
public class ScimAddGroupFailureEvent extends ScimGroupFailureEvent {

  private final String groupName;

  /**
   * Creates a SCIM add Group failure event.
   *
   ...
   */
  public ScimAddGroupFailureEvent(
      String initiator,
      String metalake,
      Exception exception,
      String groupName,
