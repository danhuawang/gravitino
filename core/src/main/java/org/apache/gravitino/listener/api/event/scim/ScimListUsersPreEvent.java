...
/** Event triggered before a SCIM list/find Users operation. */
@DeveloperApi
public class ScimListUsersPreEvent extends ScimUserPreEvent {

  private final int startIndex;
  private final int count;

  /**
   * Creates a SCIM list Users pre-event.
   *
   ...
   */
  public ScimListUsersPreEvent(String initiator, String metalake, int startIndex, int count) {
