...
class TagSearchEntitySource extends ParentEntitySource {
   ...
   */
  static TagSearchEntitySource ofAssociatedEntities(String metalake, String tagName) {
    return new TagSearchEntitySource(
   ...
   */
  static TagSearchEntitySource ofIndexedEntities(
  ...
  static TagSearchEntitySource ofIndexedEntities(
    ...
    return new TagSearchEntitySource(metalake, tagName, taggedEntities, false, true);
  }

  private TagSearchEntitySource(
      String metalake,
      String tagName,
