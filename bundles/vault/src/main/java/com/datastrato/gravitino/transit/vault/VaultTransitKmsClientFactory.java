...
public final class VaultTransitKmsClientFactory implements KmsClientFactory {
  ...
  static final String PROVIDER_NAME = "Vault Transit";

  /** Canonical API identifier for Vault Transit. */
  public static final String API = "vault-transit";
  ...
  /** Property containing the name of the environment variable holding the Vault bearer token. */
  ...
  /** Creates a Vault Transit KMS client factory. */
  public VaultTransitKmsClientFactory() {
    this(System::getenv);
  }

  VaultTransitKmsClientFactory(Function<String, String> environmentLookup) {
