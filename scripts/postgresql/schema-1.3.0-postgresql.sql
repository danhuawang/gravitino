...
CREATE TABLE IF NOT EXISTS dashboard_metrics (
    ...
    metric_state VARCHAR(16) NOT NULL DEFAULT 'COMPLETE',
    metric_message VARCHAR(1024) NULL,
...
COMMENT ON COLUMN dashboard_metrics.metric_name IS 'metric name';
COMMENT ON COLUMN dashboard_metrics.metric_value IS 'metric value';
COMMENT ON COLUMN dashboard_metrics.metric_state IS 'metric collection state';
COMMENT ON COLUMN dashboard_metrics.metric_message IS 'safe metric collection message';
...
COMMENT ON COLUMN dashboard_metric_current.metric_state IS 'metric collection state';
COMMENT ON COLUMN dashboard_metric_current.metric_message IS 'safe metric collection message';
