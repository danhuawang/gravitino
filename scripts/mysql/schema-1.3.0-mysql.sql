...
CREATE TABLE IF NOT EXISTS `dashboard_metrics` (
    ...
    `metric_value` DOUBLE NULL COMMENT 'metric value',
    `metric_state` VARCHAR(16) NOT NULL DEFAULT 'COMPLETE' COMMENT 'metric collection state',
    `metric_message` VARCHAR(1024) NULL COMMENT 'safe metric collection message',
...
CREATE TABLE IF NOT EXISTS `license_nodes` (
    ...
    PRIMARY KEY (`node_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin COMMENT='tracks active Gravitino nodes for license enforcement';
