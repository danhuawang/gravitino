...
-- job_started_at is already present in enterprise schema-1.3.0 (backported with
-- the job queuedAt/startedAt feature). Do not ADD COLUMN here; OSS main still
-- adds it in this upgrade because its 1.3.0 baseline lacks the column.
