 ...
 * metalake user list rows with identity-store origin and group list rows with an {@code
 * inBuiltInIdp} flag. All are read-only and are not written to the database.
 */
